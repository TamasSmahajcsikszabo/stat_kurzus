...
Az alábbi ábrán egy 2-4 fok közötti polinomiális trendvonalat illesztettem az adatokra. A legvilágosabb vonal lineáris trendvonal, míg a 2-4 fokok közti vonalak jelentős átfedéssel a sötét trendvonalak.
...
exploration_plot(selected_data, pol=4, autotune=FALSE, multiple_lines = TRUE)
#ars_data <- readRDS("ars_data.RDS")
```

Mint a lentebbi táblázatból látható, a megmagyarázott variancia, noha kis fölénnyel, de egy másodfokú polinomiális 
#```{r echo=FALSE, fig.width = 10, fig.height=10}
#knitr::kable(ars_data)
#```
