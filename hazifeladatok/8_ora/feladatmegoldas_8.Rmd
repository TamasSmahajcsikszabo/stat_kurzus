...
7 klaszteres megoldás esetén Ward-módszerével végzett hierarchikus agglomeratív klaszterelemzésnél ugyanaezen a mintán az EESS% = 76.83%, tehát a két megoldás ugyanannyi varianciát magyaráz. 
...
centroids <- read_delim("SPSS/centroids.csv", delim=";") %>% 
 ...
 ggplot(centroids) + 
    ...
    scale_fill_manual(values = c("grey70", "white")) +
    labs(
      title = "Klasztercentroidok k=7 struktúra esetén, nem standardizált átlagokkal",
      x = "Változók",
      y = "Átlagok"
  ) +
    theme(axis.text.x = element_text(angle = 45, hjust=1))
