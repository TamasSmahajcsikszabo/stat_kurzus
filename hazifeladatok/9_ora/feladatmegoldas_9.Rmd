...
A hét klaszteres megoldást erősíti az is, hogy egy egyedi *clustering_plot* nevű R függvényem, mely a **clusterCrit** csomag *IntCriterion*, illetve *BestCriterion* függvényei segítségével **k** különböző értékei mentén teszteli az adott R csomag adta tetszőleges illeszkedési mutatókat, és a *BestCriterion* függvény adta szavazatokat gyűjtve, numerikusan kifejezi, mely *k* lehet a legmegfelelőbb. 
Az összes (42) illeszkedési mutatót bevonva a hét klaszteres megoldás tűnik megfelelőnek. Az eredményt a függvény adta ábrával foglalom össze alább.
...
clustering_plot(dataset, k_range=7:9, method="kmeans")
```
...
**2.táblázat** Klaszterstruktúra validitás mérése ROPStattal, k-medoid klaszterelemzéshez
