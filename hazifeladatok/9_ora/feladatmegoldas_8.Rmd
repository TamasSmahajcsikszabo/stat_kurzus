...
#Sevenmembers <- memberships %>% filter(k == 7)
...
ggplot()+
    ...
    geom_point(data=plot_data_medoid, aes(x,y), color="black", size = 6, shape = 18) +
    geom_point(data=plot_data_medoid, aes(x,y, color=KL), size = 5, shape = 18) +
    facet_wrap(~var1~var2, scales="free") +
    theme_light() +
    scale_color_manual(values=c("#CB960E", "#D6A904", "#F9D47E", "987E53", "#92B7A8", "#184867", "black")) +
